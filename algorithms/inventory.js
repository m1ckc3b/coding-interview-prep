 ...
 * @param {[number, string]} arr - Array in which finding
 ...
 *
 * @param {[number, string]} arr1 - Current inventory
 * @param {[number, string]} arr2 - New inventory
 * @return {[number, string]} Update of current inventory 
 */
